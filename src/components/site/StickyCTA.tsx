...
export function StickyCTA() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col gap-3">
      <a href="https://wa.me/918686656526" target="_blank" rel="noreferrer" className="size-13 grid place-items-center rounded-full bg-[oklch(0.7_0.18_150)] text-white shadow-[var(--shadow-luxury)] hover:scale-105 transition-transform" aria-label="WhatsApp">
