...
export const Route = createFileRoute("/thank-you")({
  head: () => ({
    meta: [
      { title: "Thank You — YKS Technologies" },
      { name: "description", content: "Thank you for reaching out. An YKS Technologies specialist will be in touch within 24 hours." },
...
function ThankYou() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-32 text-center">
      ...
      <p className="mt-5 text-lg text-muted-foreground">A senior YKS Technologies specialist will reach out within 24 hours to schedule your consultation.</p>
