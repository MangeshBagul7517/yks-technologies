...
const faqs = [
  { q: "How much do premium uPVC windows cost?", a: "Aurelin systems are quoted bespoke — based on size, glazing specification, hardware grade and finish. As a guide, expect to invest in a fenestration system as you would in flooring or kitchens — it is a defining surface of the home." },
  { q: "What is the lifespan of a uPVC window?", a: "Aurelin profiles carry a 25-year warranty and are engineered to perform for 40+ years with negligible maintenance, thanks to UV-stable surfaces and steel-reinforced cores." },
  ...
  { q: "How much energy can I save?", a: "Triple-glazed Aurelin units achieve U-values down to 0.7 W/m²K, reducing HVAC loads 25–40% versus standard aluminium or single-glazed windows." },
  ...
  { q: "Are Aurelin windows secure?", a: "Multi-point European hardware, anti-lift catches and laminated security glass options deliver intrusion resistance to EN 1627 grades." },
];

export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "FAQs — uPVC Windows & Doors | Aurelin" },
